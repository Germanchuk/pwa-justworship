 ...
 *   де діє:      ЛИШЕ читання (показ + плейбек); у редагуванні й примітках
 *                капо знімається — правки летять у документ у спільній
 *                тональності, а якір примітки не з'їжджає на різниці довжин
 *                показаного й документного акорду
