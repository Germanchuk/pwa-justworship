 ...
 *   notes  — створення/редагування/видалення приміток. Як і читання, без
 *            contentEditable: тап не ставить каретку й не відкриває
 *            клавіатуру, виділення під позначку — нативне. Видно РІВНО примітки
 ...
 *
 * Примітки — читання з виділенням, і саме виділення виводить капо з гри: акорд з
 * капо показується декорацією (`displayChord` в `useChordDecorate`), тобто
