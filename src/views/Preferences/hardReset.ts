 ...
 *
 * НАВІЩО: `VitePWA` працює в режимі `registerType: "autoUpdate"` (див.
 * `vite.config.ts`), тож service worker precache-ить бандл і після деплою
 * браузер деякий час віддає стару версію. Звичайний reload цього не лікує —
